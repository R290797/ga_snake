...
PRETRAINED_MODELS = {
    ...
    "Model 3": [0.065, 0.280, 0.320, 0.130, -0.290, -0.370, -0.210, 0.510, -0.280],
    "Model 4": [0.080, 0.305, 0.340, 0.110, -0.295, -0.385, -0.215, 0.515, -0.275]
}
...
class SnakeAI:
    def __init__(self, brain=None):
        ...
        # AI Weights
        if brain is None:
            self.brain = np.random.rand(9) * 2 - 1  # Default random weights
        else:
...
def show_pretrained_models():
    ...
    model_explanations = {
        "Model 1": "50 Snakes trained over 10 generations.",
        "Model 2": "50 Snakes trained over 50 generations.",
        "Model 3": "50 Snakes trained over 100 generations.",
        "Model 4": "50 Snakes trained over 200 generations."
    }
