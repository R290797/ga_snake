...
PRETRAINED_MODELS = {
    "Hunter":       [3.104, 1.224, 0.653, 0.052, -2.372, 1.144, 0.535, 3.552, -0.808],
    "Strategist":   [1.254, 0.902, 0.405, 0.023, -1.009, -1.505, -1.112, 2.844, -1.345],
    "Explorer": 	[1.523, 0.853, -0.245, 0.313, -1.593, 0.935, 2.340, 2.722, -1.194],
    "Risk Taker": 	[3.404, 1.382, -0.589, -0.152, -3.152, 2.098, -0.752, 4.242, -0.530],
    }
