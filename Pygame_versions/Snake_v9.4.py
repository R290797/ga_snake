...
def show_training_summary(best_score, best_length, training_time):
    ...
    menu_button = pygame.Rect(WIDTH // 2 - button_width * 2 - button_spacing, HEIGHT // 1.5, button_width, button_height)
    replay_button = pygame.Rect(WIDTH // 2 - button_width - button_spacing // 2, HEIGHT // 1.5, button_width, button_height)
    quit_button = pygame.Rect(WIDTH // 2 + button_spacing, HEIGHT // 1.5, button_width, button_height)
