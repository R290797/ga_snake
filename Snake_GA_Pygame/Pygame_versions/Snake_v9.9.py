...
def main():
    while True:
        ...
        if selection == "manual":
            ...
            result = run_manual_mode()  # This will return either "menu" or "replay"
            if result == "menu":
                selection = menu_screen()  # Return to the main menu
            elif result == "replay":
                run_manual_mode()
            ...
            while True:
                ...
                # Initialize snakes for the new training run
                ...
                if best_snake is None:
                    best_weights = np.random.uniform(-0.75, 0.75, 9).tolist()
                else:
