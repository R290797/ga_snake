...
def run_generation():
    ...
    while running:
        ...
        if not alive_snakes:
            break  # End the generation if all are dead
    ...
    # **Sort snakes by fitness instead of just score**
    ...
    # **Store top performers for the next generation**
    top_performers = snakes[:10]  
    return top_performers  # Return best snakes for the next step
