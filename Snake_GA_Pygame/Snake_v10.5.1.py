...
PRETRAINED_MODELS = {
    "Hunter": [-0.081, 0.988, 0.362, 0.076, -5.385, 7.165, -6.045, -0.948, -0.741],
    "Strategist": [1.25, 0.90, 0.40, 0.02, -1.00, -1.50, -1.10, 2.80, -1.30],
    "Explorer": [1.00, 0.85, -0.20, 0.10, -1.50, 0.80, 1.50, 1.50, -1.10],
    "Risk Taker": [2.40, 1.30, -0.50, -0.05, -3.00, 2.00, -0.50, 4.20, -0.50]
}
